...
export default function LoginPage() {
  ...
  const handleClick = () => {
    ...
    const process = async () => {
      try {
        const res = await Apis.post(endpoints.adminLogin, {
          "email": email,
          "password": password
        }); 
      ...
      <StyledRoot>
        ...
        {mdUp && (
          <StyledSection>
            ...
            <img src="https://res.cloudinary.com/dexbjwfjg/image/upload/v1709322999/1707097_axqeut.png" width={500} alt="login" />
          </StyledSection>
        )}
